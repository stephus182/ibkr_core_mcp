...
**1,532 unit tests · 102 integration tests (1,634 total) · 87% line coverage (non-integration)** — all four re-measured 2026-09-17 with the commands below, per-module figures included, not carried over. Do not edit these numbers by hand; re-run the commands below.
