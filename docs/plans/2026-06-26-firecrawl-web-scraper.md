...
| `<consuming-project>/.env.example` | **Modify** | Add `FIRECRAWL_API_KEY` and `GDRIVE_WEB_DOCS_FOLDER_ID` entries |
...
**Files:**
- Modify: `<consuming-project>/.env.example`

- [ ] **Step 1: Add new env vars**

Open `/path/to/<consuming-project>/.env.example` and append:
