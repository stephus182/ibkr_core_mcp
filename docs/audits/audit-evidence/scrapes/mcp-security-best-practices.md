...
[Skip to main content](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices#content-area)

## [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#introduction)  Introduction

### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#purpose-and-scope)  Purpose and Scope
...
and best practices specific to MCP implementations.The primary audience for this document includes developers implementing
...
## [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attacks-and-mitigations)  Attacks and Mitigations

This section gives a detailed description of attacks on MCP
implementations, along with potential countermeasures.

### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#confused-deputy-problem)  Confused Deputy Problem
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#terminology)  Terminology
...
client to the third-party API server.**Third-Party Authorization Server**
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#vulnerable-conditions)  Vulnerable Conditions
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#architecture-and-attack-flows)  Architecture and Attack Flows
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation)  Mitigation
...
**OAuth State Parameter Validation**The OAuth `state` parameter is critical to prevent authorization code
...
callback endpoint.MCP proxy servers implementing OAuth flows **MUST**:
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#token-passthrough)  Token Passthrough
...
downstream API.An attacker can gain unauthorized access or otherwise compromise an
...
[“confused deputy” problem](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices#confused-deputy-problem), where the
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-2)  Mitigation

MCP servers **MUST NOT** accept any tokens that were not explicitly
issued for the MCP server.

### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#server-side-request-forgery-ssrf)  Server-Side Request Forgery (SSRF)
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-2)  Attack Description
...
Internal ServiceMalicious MCP ServerMCP ClientInternal ServiceMalicious MCP ServerMCP ClientClient follows URL without validationError or response details leak to attackerConnect to MCP server401 + resource\_metadata="http://169.254.169.254/..."GET http://169.254.169.254/latest/meta-data/Cloud credentials/metadataSubsequent request with error details

#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks-2)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-3)  Mitigation
...
Which protections are appropriate depend on your network environment.**Enforce HTTPS**MCP clients **SHOULD** require HTTPS for all OAuth-related URLs in
...
**Block Private IP Ranges**MCP clients **SHOULD** block requests to private and reserved IP address
...
**Validate Redirect Targets**MCP clients **SHOULD** apply the same URL validation to redirect
targets:
...
**Use Egress Proxies**For server-side MCP client deployments, operators **SHOULD** consider
...
**DNS Resolution Considerations**Be aware of Time-of-Check to Time-of-Use (TOCTOU) issues with
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#ssrf-against-authorization-servers)  SSRF Against Authorization Servers
...
has access to.The mitigations described above, such as blocking private IP ranges
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#resources-and-tools)  Resources and Tools

The following resources can help developers implement SSRF protections
in MCP clients.**Reference Documentation**
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#state-handle-hijacking)  State Handle Hijacking
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-3)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-4)  Mitigation
...
as authentication.MCP servers **SHOULD** use secure, non-deterministic handles generated
...
also reduce the risk.MCP servers **SHOULD** bind handles server-side to the authenticated
...
impersonate another user.For guidance on securing the server-assigned session IDs used by
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#local-mcp-server-compromise)  Local MCP Server Compromise
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-4)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks-3)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-5)  Mitigation

If an MCP client supports one-click local MCP server configuration, it
**MUST** implement proper consent mechanisms prior to executing commands.**Pre-Configuration Consent**Display a clear consent dialog before connecting a new local MCP server
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#oauth-authorization-url-validation)  OAuth Authorization URL Validation
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-5)  Attack Description
...
**stdio Transport Privilege Escalation**When XSS vulnerabilities are combined with `stdio` transport capabilities,
attackers can escalate web-based attacks to full system compromise. See
[stdio Transport Security in Proxy Scenarios](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices#stdio-transport-security-in-proxy-scenarios)
for detailed attack vectors and mitigations.

Host SystemMCP ProxyMCP ClientMalicious MCP ServerHost SystemMCP ProxyMCP ClientMalicious MCP ServerUsing stolen authentication tokenMalicious authorization URL (javascript:)Execute JavaScript (XSS)Extract proxy auth tokenMalicious stdio command requestExecute arbitrary commandCommand outputCommand resultExfiltrate data/establish persistence

#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks-4)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-6)  Mitigation

**URL Scheme Validation**MCP clients **MUST** validate authorization URLs and reject dangerous schemes:
...
**Secure URL Opening**MCP clients **MUST** avoid shell execution when opening URLs:
...
**Content Security Policy (CSP)**Web-based MCP clients **SHOULD** implement Content Security Policy headers to prevent JavaScript execution:
...
**Input Sanitization**MCP clients **MUST** sanitize and validate all URLs received from MCP servers:
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#stdio-transport-security-in-proxy-scenarios)  stdio Transport Security in Proxy Scenarios
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-6)  Attack Description

**Important**: This attack vector only applies to MCP implementations that use a proxy architecture, not to direct `stdio` transport usage.In proxy-based MCP implementations, a local proxy service sits between the client and MCP servers, spawning servers as child processes via the `stdio` transport. This architecture creates a privileged escalation path when combined with client-side vulnerabilities:
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks-5)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-7)  Mitigation

The primary defense is to prevent classes of vulnerabilities that enable this attack vector:

- Implement the mitigations described in [OAuth Authorization URL Validation](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices#oauth-authorization-url-validation)
...
Since XSS fundamentally compromises the client’s security context, focus on limiting the damage:**stdio Transport Restrictions**MCP proxy services **SHOULD** implement additional security controls for `stdio` transport:
...
**Client-Side Protections**MCP clients **SHOULD** implement defense-in-depth measures:
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mix-up-attacks)  Mix-Up Attacks

#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-7)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-8)  Mitigation
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#localhost-redirect-uri-impersonation)  Localhost Redirect URI Impersonation
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-8)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-9)  Mitigation
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#cimd-trust-policies)  CIMD Trust Policies
...
### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#scope-minimization)  Scope Minimization

Poor scope design increases token compromise impact, elevates user
friction, and obscures audit trails.

#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#attack-description-9)  Attack Description
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#risks-6)  Risks
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#mitigation-10)  Mitigation
...
The choice depends on the server’s assessment of user experience impact and authorization friction.Client guidance:
...
#### [​](https://modelcontextprotocol.io/docs/2026-07-28/tutorials/security/security_best_practices\#common-mistakes)  Common Mistakes
