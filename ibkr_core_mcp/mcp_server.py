        ...
        try:
            if path == "ibkr://accounts":
                ...
                if account_id:
                    ...
                    # get_all_positions, not page 0 alone — see API-17 in client.py.
                    positions = toolkit._client.get_all_positions(account_id)
                    text = json.dumps(positions, indent=2, default=json_default)
                else:
